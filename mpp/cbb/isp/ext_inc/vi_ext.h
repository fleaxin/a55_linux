...
typedef td_s32  fn_vi_update_vi_video_mode(ot_vi_video_mode video_mode);
...
typedef struct {
    ...
    fn_vi_update_vi_video_mode        *pfn_vi_update_vi_video_mode;
...
#define ckfn_vi_update_vi_video_mode() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_update_vi_video_mode != TD_NULL)
#define call_vi_update_vi_video_mode(video_mode) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_update_vi_video_mode(video_mode)
