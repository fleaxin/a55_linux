...
#define VREG_CSC_SIZE               0x70 /* 0x40 reserved */
...
/* HNR:0x19620~0x1967F */
#define VREG_HNR_OFFSET          (VREG_AGAMMA_OFFSET + VREG_AGAMMA_SIZE)
#define VREG_HNR_SIZE            0x60
#define vreg_hnr_base(vi_pipe)   (ot_ext_base_addr(vi_pipe) + VREG_HNR_OFFSET)

/* HNR:0x19680~0x196FF */
#define VREG_SNS_OFFSET          (VREG_HNR_OFFSET + VREG_HNR_SIZE)
...
static __inline td_void ot_ext_system_isp_pipe_diff_mode_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_top_base(vi_pipe) + 0x227, data & 0x1);
}
static __inline td_u8 ot_ext_system_isp_pipe_diff_mode_read(ot_vi_pipe vi_pipe)
{
    return ((iord_8direct(vreg_top_base(vi_pipe) + 0x227)) & 0x1);
}
...
{
    iowr_32direct(vreg_top_base(vi_pipe) + 0x308, data);
}

static __inline td_u32 ot_ext_system_fswdr_mode_read(ot_vi_pipe vi_pipe)
{
    return (iord_32direct(vreg_top_base(vi_pipe) + 0x308));
}
...
static __inline td_void ot_ext_system_drc_low_sat_ctrl_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_drc_base(vi_pipe) + 0x299), data);
}

static __inline td_u8 ot_ext_system_drc_low_sat_ctrl_read(ot_vi_pipe vi_pipe)
{
...
{
    iowr_8direct(vreg_blc_base(vi_pipe) + 0xa, data);
}
static __inline td_u8 ot_ext_system_black_level_mode_read(ot_vi_pipe vi_pipe)
{
    return iord_8direct(vreg_blc_base(vi_pipe) + 0xa);
}
...
static __inline td_void ot_ext_system_dpc_dynamic_manual_enable_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_dpc_base(vi_pipe)  +  0xe, data & 0x1);
}
static __inline td_u8 ot_ext_system_dpc_dynamic_manual_enable_read(ot_vi_pipe vi_pipe)
{
...
{
    iowr_8direct(vreg_dpc_base(vi_pipe) + 0xf, (data & 0x01));
}

static __inline td_u8 ot_ext_system_isp_dpc_init_status_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_dpc_base(vi_pipe) + 0xf) & 0x01);
}

/* register: ot_ext_system_dpc_dynamic_strength_table */
/* dpc_dynamic_strength_table */
/* addr range dpc[0x10, 0x30) index:16 */
static __inline td_void ot_ext_system_dpc_dynamic_strength_table_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct(vreg_dpc_base(vi_pipe)  +  0x10  + index * sizeof(td_u16), data);
}

static __inline td_u16 ot_ext_system_dpc_dynamic_strength_table_read(ot_vi_pipe vi_pipe,  td_u8 index)
{
    return iord_16direct(vreg_dpc_base(vi_pipe)  +  0x10  +  index * sizeof(td_u16));
}

/* register: ot_ext_system_dpc_dynamic_blend_ratio_table */
/* dpc_blend_ratio_table */
/* addr range dpc[0x30, 0x50) index:16 */
static __inline td_void ot_ext_system_dpc_dynamic_blend_ratio_table_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct(vreg_dpc_base(vi_pipe)  +  0x30  + index * sizeof(td_u16), data);
}

static __inline td_u16 ot_ext_system_dpc_dynamic_blend_ratio_table_read(ot_vi_pipe vi_pipe,  td_u8 index)
{
    return iord_16direct(vreg_dpc_base(vi_pipe)  +  0x30   +  index * sizeof(td_u16));
}

/* register: ot_ext_system_dpc_dynamic_strength */
/* dpc_dynamic_strength */
#define OT_EXT_SYSTEM_DPC_DYNAMIC_STRENGTH_DEFAULT 0x0
static __inline td_void ot_ext_system_dpc_dynamic_strength_write(ot_vi_pipe vi_pipe,  td_u16 data)
{
    iowr_16direct(vreg_dpc_base(vi_pipe)  +  0x50, data);
}

static __inline td_u16 ot_ext_system_dpc_dynamic_strength_read(ot_vi_pipe vi_pipe)
{
...
static __inline td_void ot_ext_system_dpc_dynamic_blend_ratio_write(ot_vi_pipe vi_pipe,  td_u16 data)
{
    iowr_16direct(vreg_dpc_base(vi_pipe)  +  0x52, data);
}

static __inline td_u16 ot_ext_system_dpc_dynamic_blend_ratio_read(ot_vi_pipe vi_pipe)
{
    return iord_16direct(vreg_dpc_base(vi_pipe)  +  0x52);
}

/* register: ot_ext_system_dpc_manual_mode */
#define OT_EXT_SYSTEM_DPC_MANU_MODE_DEFAULT 0x0
static __inline td_void ot_ext_system_dpc_manual_mode_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_dpc_base(vi_pipe)  +  0x54, data & 0x1);
}
static __inline td_u8 ot_ext_system_dpc_manual_mode_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_dpc_base(vi_pipe)  +  0x54) & 0x1);
}

/* register: ot_ext_system_dpc_alpha0_rb_write */
/* ot_ext_system_dpc_alpha0_rb_write */
#define OT_EXT_SYSTEM_DPC_DYNAMIC_ALPHA0_RB_DEFAULT  0x0
static __inline td_void ot_ext_system_dpc_alpha0_rb_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_dpc_base(vi_pipe)  +  0x55, data);
}
static __inline td_u8 ot_ext_system_dpc_alpha0_rb_read(ot_vi_pipe vi_pipe)
{
...
/* register: ot_ext_system_dpc_alpha0_rb_write */
/* ot_ext_system_dpc_alpha0_rb_write */
#define OT_EXT_SYSTEM_DPC_DYNAMIC_ALPHA0_G_DEFAULT 0x0
static __inline td_void ot_ext_system_dpc_alpha0_g_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_dpc_base(vi_pipe)  +  0x56, data);
}
static __inline td_u8 ot_ext_system_dpc_alpha0_g_read(ot_vi_pipe vi_pipe)
{
...
static __inline td_void ot_ext_system_dpc_suppress_twinkle_enable_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_dpc_base(vi_pipe) + 0x57, data & 0x1);
}
static __inline td_u8 ot_ext_system_dpc_suppress_twinkle_enable_read(ot_vi_pipe vi_pipe)
{
...
static __inline td_void ot_ext_system_dpc_suppress_twinkle_thr_write(ot_vi_pipe vi_pipe, td_s8 data)
{
    iowr_16direct(vreg_dpc_base(vi_pipe) + 0x58, data);
}
static __inline td_s8 ot_ext_system_dpc_suppress_twinkle_thr_read(ot_vi_pipe vi_pipe)
{
...
static __inline td_void ot_ext_system_dpc_suppress_twinkle_slope_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_dpc_base(vi_pipe) + 0x59, data & 0xFF);
}
static __inline td_u8 ot_ext_system_dpc_suppress_twinkle_slope_read(ot_vi_pipe vi_pipe)
{
...
/* register: ot_ext_system_dpc_bpt_cor_number */
...
#define OT_EXT_SYSTEM_DPC_BRIGHT_STRENGTH_DEFAULT 0x40
static __inline td_void ot_ext_system_dpc_bright_strength_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_dpc_base(vi_pipe) + 0x60, data);
}
static __inline td_u8 ot_ext_system_dpc_bright_strength_read(ot_vi_pipe vi_pipe)
{
    return iord_8direct(vreg_dpc_base(vi_pipe) + 0x60);
}

#define OT_EXT_SYSTEM_DPC_DARK_STRENGTH_DEFAULT 0x40
static __inline td_void ot_ext_system_dpc_dark_strength_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_dpc_base(vi_pipe) + 0x61, data);
}
static __inline td_u8 ot_ext_system_dpc_dark_strength_read(ot_vi_pipe vi_pipe)
{
    return iord_8direct(vreg_dpc_base(vi_pipe) + 0x61);
}
...
static __inline td_void ot_ext_system_bayernr_lsc_ratio2_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x05), data);
}

static __inline td_u8 ot_ext_system_bayernr_lsc_ratio2_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x05));
}
/* addr range bnr[0x6, 0x48) index:33 */
...
/* addr range bnr[0x48, 0x58) index:16 */
static __inline td_void ot_ext_system_bayernr_auto_sfm_threshold_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x48 + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_sfm_threshold_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x48 + sizeof(td_u8) * index)));
}
/* addr range bnr[0x58, 0x68) index:16 */
static __inline td_void ot_ext_system_bayernr_auto_sfm0_mode_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x58 + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_sfm0_mode_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x58 + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_sfm0_coarse_strength_r_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u16 data)
{
    iowr_16direct((vreg_bnr_base(vi_pipe) + 0x68 + sizeof(td_u16) * index), data);
}

static __inline td_u16 ot_ext_system_bayernr_auto_sfm0_coarse_strength_r_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct((vreg_bnr_base(vi_pipe) + 0x68 + sizeof(td_u16) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_sfm0_coarse_strength_gr_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u16 data)
{
...
static __inline td_void ot_ext_system_bayernr_auto_sfm0_coarse_strength_gb_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u16 data)
{
...
static __inline td_void ot_ext_system_bayernr_auto_sfm0_coarse_strength_b_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u16 data)
{
...
static __inline td_void ot_ext_system_bayernr_auto_sfm0_ex_strength_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0xE8 + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_sfm0_ex_strength_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0xE8 + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_sfm0_ex_detail_prot_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0xF8 + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_sfm0_ex_detail_prot_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0xF8 + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_sfm0_norm_edge_strength_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x108 + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_sfm0_norm_edge_strength_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x108 + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_sfm1_detail_prot_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x118 + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_sfm1_detail_prot_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x118 + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_sfm1_coarse_strength_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x128 + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_sfm1_coarse_strength_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
...
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x148 + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_fine_strength_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x148 + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_coring_wgt_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_bnr_base(vi_pipe) + 0x158 + sizeof(td_u16) * index), data);
}

static __inline td_u16 ot_ext_system_bayernr_auto_coring_wgt_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct((vreg_bnr_base(vi_pipe) + 0x158 + sizeof(td_u16) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_coring_mot_thresh_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x178 + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_coring_mot_thresh_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x178 + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm_threshold_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x188), data);
}

static __inline td_u8 ot_ext_system_bayernr_manual_sfm_threshold_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x188));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm0_mode_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x189), data);
}

static __inline td_u8 ot_ext_system_bayernr_manual_sfm0_mode_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x189));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm0_coarse_strength_r_write(ot_vi_pipe vi_pipe, td_u16 data)
{
    iowr_16direct((vreg_bnr_base(vi_pipe) + 0x18A), data);
}

static __inline td_u16 ot_ext_system_bayernr_manual_sfm0_coarse_strength_r_read(ot_vi_pipe vi_pipe)
{
    return (iord_16direct(vreg_bnr_base(vi_pipe) + 0x18A));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm0_coarse_strength_gr_write(ot_vi_pipe vi_pipe, td_u16 data)
{
    iowr_16direct((vreg_bnr_base(vi_pipe) + 0x18C), data);
}

static __inline td_u16 ot_ext_system_bayernr_manual_sfm0_coarse_strength_gr_read(ot_vi_pipe vi_pipe)
{
    return (iord_16direct(vreg_bnr_base(vi_pipe) + 0x18C));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm0_coarse_strength_gb_write(ot_vi_pipe vi_pipe, td_u16 data)
{
    iowr_16direct((vreg_bnr_base(vi_pipe) + 0x18E), data);
}

static __inline td_u16 ot_ext_system_bayernr_manual_sfm0_coarse_strength_gb_read(ot_vi_pipe vi_pipe)
{
    return (iord_16direct(vreg_bnr_base(vi_pipe) + 0x18E));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm0_coarse_strength_b_write(ot_vi_pipe vi_pipe, td_u16 data)
{
    iowr_16direct((vreg_bnr_base(vi_pipe) + 0x190), data);
}

static __inline td_u16 ot_ext_system_bayernr_manual_sfm0_coarse_strength_b_read(ot_vi_pipe vi_pipe)
{
    return (iord_16direct(vreg_bnr_base(vi_pipe) + 0x190));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm0_ex_strength_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x192), data);
}

static __inline td_u8 ot_ext_system_bayernr_manual_sfm0_ex_strength_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x192));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm0_ex_detail_prot_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x193), data);
}

static __inline td_u8 ot_ext_system_bayernr_manual_sfm0_ex_detail_prot_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x193));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm0_norm_edge_strength_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x194), data);
}

static __inline td_u8 ot_ext_system_bayernr_manual_sfm0_norm_edge_strength_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x194));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm1_detail_prot_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x195), data);
}

static __inline td_u8 ot_ext_system_bayernr_manual_sfm1_detail_prot_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x195));
}

static __inline td_void ot_ext_system_bayernr_manual_sfm1_coarse_strength_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x196), data);
}

static __inline td_u8 ot_ext_system_bayernr_manual_sfm1_coarse_strength_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x196));
}

static __inline td_void ot_ext_system_bayernr_manual_fine_strength_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x198), data);
}

static __inline td_u8 ot_ext_system_bayernr_manual_fine_strength_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x198));
}

static __inline td_void ot_ext_system_isp_bayernr_init_status_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_bnr_base(vi_pipe) + 0x199, (data & 0x01));
}

static __inline td_u8 ot_ext_system_isp_bayernr_init_status_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x199) & 0x01);
}

static __inline td_void ot_ext_system_bayernr_manual_coring_wgt_write(ot_vi_pipe vi_pipe, td_u16 data)
{
    iowr_16direct((vreg_bnr_base(vi_pipe) + 0x19A), data);
}

static __inline td_u16 ot_ext_system_bayernr_manual_coring_wgt_read(ot_vi_pipe vi_pipe)
{
    return (iord_16direct(vreg_bnr_base(vi_pipe) + 0x19A));
}

static __inline td_void ot_ext_system_bayernr_manual_coring_mot_thresh_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x19C), data);
}

static __inline td_u8 ot_ext_system_bayernr_manual_coring_mot_thresh_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x19C));
}

static __inline td_void ot_ext_system_bayernr_auto_md_mode_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x19D + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_md_mode_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x19D + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_md_anti_flicker_strength_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x1AD + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_md_anti_flicker_strength_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x1AD + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_md_static_ratio_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x1BD + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_md_static_ratio_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x1BD + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_md_static_fine_strength_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x1CD + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_md_static_fine_strength_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x1CD + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_tss_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x1DD + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_tss_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x1DD + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_tfr_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x1ED + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_tfr_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x1ED + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_tfs_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x1FD + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_tfs_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x1FD + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_user_define_md_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x20D + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_user_define_md_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x20D + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_user_define_bri_thresh_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_s16 data)
{
    iowr_16direct((vreg_bnr_base(vi_pipe) + 0x21E + sizeof(td_s16) * index), data);
}

static __inline td_s16 ot_ext_system_bayernr_auto_user_define_bri_thresh_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct((vreg_bnr_base(vi_pipe) + 0x21E + sizeof(td_s16) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_user_define_dark_thresh_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u16 data)
{
    iowr_16direct((vreg_bnr_base(vi_pipe) + 0x23E + sizeof(td_u16) * index), data);
}

static __inline td_u16 ot_ext_system_bayernr_auto_user_define_dark_thresh_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct((vreg_bnr_base(vi_pipe) + 0x23E + sizeof(td_u16) * index)));
}

static __inline td_void ot_ext_system_bayernr_auto_user_define_color_thresh_lut_write(ot_vi_pipe vi_pipe, td_u8 index,
    td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x25E + sizeof(td_u8) * index), data);
}

static __inline td_u8 ot_ext_system_bayernr_auto_user_define_color_thresh_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x25E + sizeof(td_u8) * index)));
}
...
/* bnrmode */
#define OT_EXT_SYSTEM_BNR_MODE_WRITE_DEFAULT 1
static __inline td_void ot_ext_system_bnr_mode_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_wdr_base(vi_pipe) + 0x21, data);
}
static __inline td_u8 ot_ext_system_bnr_mode_read(ot_vi_pipe vi_pipe)
{
...
/* isp_wdr_bginfo_low_thd0 */
static __inline td_void ot_ext_system_wdr_bginfo_low_thd_write(ot_vi_pipe vi_pipe, td_u16 data)
{
    iowr_16direct(vreg_wdr_base(vi_pipe) + 0x100, data);
}

static __inline td_u16 ot_ext_system_wdr_bginfo_low_thd_read(ot_vi_pipe vi_pipe)
{
    return (iord_16direct(vreg_wdr_base(vi_pipe) + 0x100));
}

/* isp_wdr_bginfo_high_thd0 */
static __inline td_void ot_ext_system_wdr_bginfo_high_thd_write(ot_vi_pipe vi_pipe, td_u16 data)
{
    iowr_16direct(vreg_wdr_base(vi_pipe) + 0x102, data);
}

static __inline td_u16 ot_ext_system_wdr_bginfo_high_thd_read(ot_vi_pipe vi_pipe)
{
    return (iord_16direct(vreg_wdr_base(vi_pipe) + 0x102));
}
...
static __inline td_void ot_ext_system_wdr_bginfo_en_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_wdr_base(vi_pipe) + 0x250, data);
}

static __inline td_u8 ot_ext_system_wdr_bginfo_en_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_wdr_base(vi_pipe) + 0x250));
}
...
static __inline td_void ot_ext_system_isp_bnr_lsc_auto_enable_write(ot_vi_pipe vi_pipe,  td_u8 data)
{
    iowr_8direct(vreg_lsc_base(vi_pipe)  +  0x6, data & 0x1);
}

static __inline td_u8 ot_ext_system_isp_bnr_lsc_auto_enable_read(ot_vi_pipe vi_pipe)
{
...
static __inline td_void ot_ext_system_isp_bnr_shading_r_gain_write(ot_vi_pipe vi_pipe,  td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_lsc_base(vi_pipe) + 0x4462 + index * sizeof(td_u16)), data);
}

static __inline td_u16 ot_ext_system_isp_bnr_shading_r_gain_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct((vreg_lsc_base(vi_pipe) + 0x4462 + index * sizeof(td_u16))));
}

/* length : 129; bytes : 129*2 = 258 = 0x102 */
static __inline td_void ot_ext_system_isp_bnr_shading_gr_gain_write(ot_vi_pipe vi_pipe,  td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_lsc_base(vi_pipe) + 0x4564 + index * sizeof(td_u16)), data);
}

static __inline td_u16 ot_ext_system_isp_bnr_shading_gr_gain_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct((vreg_lsc_base(vi_pipe) + 0x4564 + index * sizeof(td_u16))));
}

/* length : 129; bytes : 129*2 = 258 = 0x102 */
static __inline td_void ot_ext_system_isp_bnr_shading_gb_gain_write(ot_vi_pipe vi_pipe,  td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_lsc_base(vi_pipe) + 0x4666 + index * sizeof(td_u16)), data);
}

static __inline td_u16 ot_ext_system_isp_bnr_shading_gb_gain_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct((vreg_lsc_base(vi_pipe) + 0x4666 + index * sizeof(td_u16))));
}

/* length : 129; bytes : 129*2 = 258 = 0x102 */
/* addr range BNR[0x4768, 0x486a) index:129 */
static __inline td_void ot_ext_system_isp_bnr_shading_b_gain_write(ot_vi_pipe vi_pipe,  td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_lsc_base(vi_pipe) + 0x4768 + index * sizeof(td_u16)), data);
}

static __inline td_u16 ot_ext_system_isp_bnr_shading_b_gain_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct((vreg_lsc_base(vi_pipe) + 0x4768 + index * sizeof(td_u16))));
}
...
/* ***********************************edge_smooth_str 8bit 0x3-0x3******************************************* */
#define OT_EXT_SYSTEM_BSHP_EDGE_SMOOTH_STR_DEFAULT 0
static __inline td_void ot_ext_system_bshp_edge_filt_str_manual_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bshp_base(vi_pipe) + 0x03), data);
}

static __inline td_u8 ot_ext_system_bshp_edge_filt_str_manual_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bshp_base(vi_pipe) + 0x03));
}

/* ***********************************sharpen_gain_max 16bit 0x4-0x5*************************************** */
#define OT_EXT_SYSTEM_BSHP_SARPEN_GAIN_MAX_DEFAULT 150
static __inline td_void ot_ext_system_bshp_edge_max_gain_manual_write(ot_vi_pipe vi_pipe, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe) + 0x04), data);
}

static __inline td_u16 ot_ext_system_bshp_edge_max_gain_manual_read(ot_vi_pipe vi_pipe)
{
    return (iord_16direct(vreg_bshp_base(vi_pipe) + 0x04));
}

/* ***********************************overshoot 16bit 0x6-0x7************************************************** */
#define OT_EXT_SYSTEM_BSHP_OVERSHOOT_DEFAULT 80
...
/* ***********************************undershoot  16bit 0x8-0xa********************************************* */
#define OT_EXT_SYSTEM_BSHP_UNDERSHOOT_DEFAULT 100
...
/* ***********************************g_chn_gain  16bit 0xa-0xc*********************************************** */
#define OT_EXT_SYSTEM_BSHP_G_CHN_GAIN_DEFAULT 50
static __inline td_void ot_ext_system_bshp_g_chn_gain_manual_write(ot_vi_pipe vi_pipe, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe) + 0x0a), data);
}

static __inline td_u16 ot_ext_system_bshp_g_chn_gain_manual_read(ot_vi_pipe vi_pipe)
{
    return (iord_16direct(vreg_bshp_base(vi_pipe) + 0x0a));
}

/* *****************************************edge_course_str*lut num 32 16bit len:0x40**0x0c-0x5c********* */
static __inline td_void ot_ext_system_bshp_edge_mf_str_manual_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe) + 0x0c + (sizeof(td_u16) * index)), data);
}

static __inline td_u16 ot_ext_system_bshp_edge_mf_str_manual_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct((vreg_bshp_base(vi_pipe) + 0x0c + (sizeof(td_u16) * index))));
}


/* ********************************************detail_course_str***0x5c-0x9c********************************** */
static __inline td_void ot_ext_system_bshp_tex_mf_str_manual_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe) + 0x5c + (sizeof(td_u16) * index)), data);
}

static __inline td_u16 ot_ext_system_bshp_text_mf_str_manual_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct((vreg_bshp_base(vi_pipe) + 0x5c + (sizeof(td_u16) * index))));
}

/* **************************************luma_wgt***32x8bit len:0x20****0x9c-0xbc******************************* */
static __inline td_void ot_ext_system_bshp_luma_wgt_manual_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u8 data)
{
    iowr_8direct((vreg_bshp_base(vi_pipe) + 0x9c + (sizeof(td_u8) * index)), data);
}

static __inline td_u8 ot_ext_system_bshp_luma_wgt_manual_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_8direct((vreg_bshp_base(vi_pipe) + 0x9c + (sizeof(td_u8) * index))));
}


/* *********************************edge_fine_str****32x16bit len:0x40****0xbc-0xfc************************** */
static __inline td_void ot_ext_system_bshp_edge_hf_str_manual_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe) + 0xbc + (sizeof(td_u16) * index)), data);
}

static __inline td_u16 ot_ext_system_bshp_edge_hf_str_manual_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct(vreg_bshp_base(vi_pipe) + 0xbc + (sizeof(td_u16) * index)));
}

/* *********************************detail_fine_str*****32x16bit len:0x40****0xfc-0x13c********************* */
static __inline td_void ot_ext_system_bshp_tex_hf_str_manual_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe) + 0xfc + (sizeof(td_u16) * index)), data);
}

static __inline td_u16 ot_ext_system_bshp_tex_hf_str_manual_lut_read(ot_vi_pipe vi_pipe, td_u8 index)
{
    return (iord_16direct(vreg_bshp_base(vi_pipe) + 0xfc + (sizeof(td_u16) * index)));
}

/* *****************************edge_fine_str auoto 16 level***iso 16x32lutx16bit len:0x400 0x13c-0x53c************ */
static __inline td_void ot_ext_system_bshp_edge_hf_str_auto_lut_write(ot_vi_pipe vi_pipe, td_u16 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe)  +  0x13c  +  index * sizeof(td_u16)), data);
}
static __inline td_u16 ot_ext_system_bshp_edge_hf_str_auto_lut_read(ot_vi_pipe vi_pipe,  td_u16 index)
{
    return ((iord_16direct((vreg_bshp_base(vi_pipe)  +  0x13c  +  index * sizeof(td_u16)))));
}

/* *************************detail_fine_str auoto 16 level****iso 16x32x16bit len:0x400 0x53c-0x93c************** */
static __inline td_void ot_ext_system_bshp_tex_hf_str_auto_lut_write(ot_vi_pipe vi_pipe, td_u16 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe)  +  0x53c +  index * sizeof(td_u16)), data);
}
static __inline td_u16 ot_ext_system_bshp_tex_hf_str_auto_lut_read(ot_vi_pipe vi_pipe,  td_u16 index)
{
    return ((iord_16direct((vreg_bshp_base(vi_pipe)  +  0x53c +  index * sizeof(td_u16)))));
}

/* *************************sharpen_gain_max auoto 16 level***iso 16x16bit len:0x20 0x93c-0x95c************** */
static __inline td_void ot_ext_system_bshp_edge_max_gain_auto_lut_write(ot_vi_pipe vi_pipe, td_u16 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe)  +  0x93c +  index * sizeof(td_u16)), data);
}
static __inline td_u16 ot_ext_system_bshp_edge_max_gain_auto_lut_read(ot_vi_pipe vi_pipe,  td_u16 index)
{
    return ((iord_16direct((vreg_bshp_base(vi_pipe)  +  0x93c  +  index * sizeof(td_u16)))));
}


/* **************************overshoot auoto 16 level****iso 16x16bit len:0x20 0x95c-0x97c************** */
static __inline td_void ot_ext_system_bshp_overshoot_auto_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe)  +  0x95c +  index * sizeof(td_u16)), data);
}
static __inline td_u16 ot_ext_system_bshp_overshoot_auto_lut_read(ot_vi_pipe vi_pipe,  td_u8 index)
{
    return ((iord_16direct((vreg_bshp_base(vi_pipe)  +  0x95c +  index * sizeof(td_u16)))));
}


/* ***************************undershoot auoto 16 level****iso 16x16bit len:0x20 0x97c-0x99c************* */
static __inline td_void ot_ext_system_bshp_undershoot_auto_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe)  +  0x97c  +  index * sizeof(td_u16)), data);
}
static __inline td_u16 ot_ext_system_bshp_undershoot_auto_lut_read(ot_vi_pipe vi_pipe,  td_u8 index)
{
    return ((iord_16direct((vreg_bshp_base(vi_pipe)  +  0x97c  +  index * sizeof(td_u16)))));
}


/* ****************************g_chn_gain auoto 16 level*****iso 16x16bit len:0x20 0x99c-0x9bc*************** */
static __inline td_void ot_ext_system_bshp_g_chn_gain_auto_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe)  +  0x99c  +  index * sizeof(td_u16)), data);
}
static __inline td_u16 ot_ext_system_bshp_g_chn_gain_auto_lut_read(ot_vi_pipe vi_pipe,  td_u8 index)
{
    return ((iord_16direct((vreg_bshp_base(vi_pipe)  +  0x99c  +  index * sizeof(td_u16)))));
}


/* ***************************edge_smooth_str auoto 16 level**iso 16x16bit len:0x20 0x9bc-0x9dc************* */
static __inline td_void ot_ext_system_bshp_edge_filt_str_auto_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u8 data)
{
    iowr_8direct((vreg_bshp_base(vi_pipe) + 0x9bc + index * sizeof(td_u8)), data);
}
static __inline td_u8 ot_ext_system_bshp_edge_filt_str_auto_lut_read(ot_vi_pipe vi_pipe,  td_u8 index)
{
    return ((iord_8direct((vreg_bshp_base(vi_pipe) + 0x9bc + index * sizeof(td_u8)))));
}

/* ***************************detail_course_str auoto 16 level***iso 16x32lutx16bit len:0x400 0x9dc-0xddc************ */
static __inline td_void ot_ext_system_bshp_tex_mf_str_auto_lut_write(ot_vi_pipe vi_pipe, td_u16 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe) + 0x9dc + index * sizeof(td_u16)), data);
}
static __inline td_u16 ot_ext_system_bshp_tex_mf_str_auto_lut_read(ot_vi_pipe vi_pipe,  td_u16 index)
{
    return ((iord_16direct((vreg_bshp_base(vi_pipe) + 0x9dc + index * sizeof(td_u16)))));
}

/* ****************edge_course_str auoto 16 level***iso 16x32lutx16bit len:0x400 0xddc-0x11dc************ */
static __inline td_void ot_ext_system_bshp_edge_mf_str_auto_lut_write(ot_vi_pipe vi_pipe, td_u16 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe)  +  0xddc  +  index * sizeof(td_u16)), data);
}
static __inline td_u16 ot_ext_system_bshp_edge_mf_str_auto_lut_read(ot_vi_pipe vi_pipe,  td_u16 index)
{
    return ((iord_16direct((vreg_bshp_base(vi_pipe)  +  0xddc  +  index * sizeof(td_u16)))));
}

/* ***************************luma_wgt auoto 16 level*****iso 16x32lutx16bit len:0x400 0x11dc-0x15dc*********** */
static __inline td_void ot_ext_system_bshp_luma_wgt_auto_lut_write(ot_vi_pipe vi_pipe, td_u16 index, td_u8 data)
{
    iowr_8direct((vreg_bshp_base(vi_pipe)  +  0x11dc  +  index * sizeof(td_u8)), data);
}
static __inline td_u8 ot_ext_system_bshp_luma_wgt_auto_lut_read(ot_vi_pipe vi_pipe,  td_u16 index)
{
    return ((iord_8direct((vreg_bshp_base(vi_pipe)  +  0x11dc  +  index * sizeof(td_u8)))));
}

/* ************detail_max_str auoto 16 level******iso 16x16bit len:0x20 0x15dc-0x15fc********************** */
static __inline td_void ot_ext_system_bshp_tex_max_gain_auto_lut_write(ot_vi_pipe vi_pipe, td_u8 index, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe)  +  0x15dc  +  index * sizeof(td_u16)), data);
}
static __inline td_u16 ot_ext_system_bshp_tex_max_gain_auto_lut_read(ot_vi_pipe vi_pipe,  td_u8 index)
{
    return ((iord_16direct((vreg_bshp_base(vi_pipe)  +  0x15dc  +  index * sizeof(td_u16)))));
}

/* *********************************detail_max_str*******16bit len:0x2 0x15fc-0x15fe******************** */
#define OT_EXT_SYSTEM_BSHP_DETAIL_MAX_STR_DEFAULT 150
static __inline td_void ot_ext_system_bshp_tex_max_gain_manual_write(ot_vi_pipe vi_pipe, td_u16 data)
{
    iowr_16direct((vreg_bshp_base(vi_pipe) + 0x15fc), data);
}

static __inline td_u16 ot_ext_system_bshp_tex_max_gain_manual_read(ot_vi_pipe vi_pipe)
{
    return (iord_16direct(vreg_bshp_base(vi_pipe) + 0x15fc));
}

static __inline td_void ot_ext_system_isp_bshp_init_status_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_bshp_base(vi_pipe) + 0x15fe, (data & 0x01));
}

static __inline td_u8 ot_ext_system_isp_bshp_init_status_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bshp_base(vi_pipe) + 0x15fe) & 0x01);
}
...
/* register: ot_ext_system_agamma_write */
static __inline td_void ot_ext_system_agamma_enable_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_agamma_base(vi_pipe), data);
}

static __inline td_u8 ot_ext_system_agamma_enable_read(ot_vi_pipe vi_pipe)
{
    return iord_8direct(vreg_agamma_base(vi_pipe));
}
static __inline td_void ot_ext_system_adgamma_enable_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_agamma_base(vi_pipe) + 0x1, data);
}

static __inline td_u8 ot_ext_system_adgamma_enable_read(ot_vi_pipe vi_pipe)
{
    return iord_8direct(vreg_agamma_base(vi_pipe) + 0x1);
}

static __inline td_void ot_ext_system_agamma_scale_write(ot_vi_pipe vi_pipe, td_u32 data)
{
    iowr_32direct(vreg_agamma_base(vi_pipe) + 0x4, data);
}

static __inline td_u32 ot_ext_system_agamma_scale_read(ot_vi_pipe vi_pipe)
{
    return iord_32direct(vreg_agamma_base(vi_pipe) + 0x4);
}

static __inline td_void ot_ext_system_adgamma_scale_write(ot_vi_pipe vi_pipe, td_u32 data)
{
    iowr_32direct(vreg_agamma_base(vi_pipe) + 0x8, data);
}

static __inline td_u32 ot_ext_system_adgamma_scale_read(ot_vi_pipe vi_pipe)
{
    return iord_32direct(vreg_agamma_base(vi_pipe) + 0x8);
}
...
/* addr range sns[0x0, 0x7f) index:16 */
/* args: data (8-bit) */
