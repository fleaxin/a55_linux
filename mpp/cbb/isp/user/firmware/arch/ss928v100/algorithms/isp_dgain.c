...
{
    ot_unused(vi_vipe);
    dyna_reg_cfg->clip_value = 0xFFFFFF;
...
{
    ot_unused(vi_vipe);
    dyna_reg_cfg->clip_value0 = 0xFFFFFF;
    dyna_reg_cfg->clip_value1 = 0xFFFFFF;
    dyna_reg_cfg->clip_value2 = 0xFFFFFF;
    dyna_reg_cfg->clip_value3 = 0xFFFFFF;
    dyna_reg_cfg->resh = TD_TRUE;
}
