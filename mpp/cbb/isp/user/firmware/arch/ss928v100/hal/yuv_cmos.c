...
static td_void yuv_cmos_get_isp_dng_default(ot_isp_cmos_default *sns_dft)
{
    ...
    sns_dft->sensor_mode.dng_raw_format.white_level = 4095; /* white level 4095 */

    sns_dft->sensor_mode.dng_raw_format.default_scale.default_scale_hor.denominator = 1;
    sns_dft->sensor_mode.dng_raw_format.default_scale.default_scale_hor.numerator   = 1;
    sns_dft->sensor_mode.dng_raw_format.default_scale.default_scale_ver.denominator = 1;
    sns_dft->sensor_mode.dng_raw_format.default_scale.default_scale_ver.numerator   = 1;
    sns_dft->sensor_mode.dng_raw_format.cfa_repeat_pattern_dim.repeat_pattern_dim_row = 2; /* dim row 2 */
    sns_dft->sensor_mode.dng_raw_format.cfa_repeat_pattern_dim.repeat_pattern_dim_col = 2; /* dim column 2 */
    sns_dft->sensor_mode.dng_raw_format.black_level_repeat_dim.repeat_row = 2; /* row 2 */
    sns_dft->sensor_mode.dng_raw_format.black_level_repeat_dim.repeat_col = 2; /* column 2 */
    sns_dft->sensor_mode.dng_raw_format.cfa_layout = OT_ISP_CFALAYOUT_TYPE_RECTANGULAR;
    ...
    sns_dft->sensor_mode.valid_dng_raw_format = TD_TRUE;
}
...
td_s32 isp_get_yuv_default(ot_isp_cmos_default *sns_dft)
{
    ...
    sns_dft->sensor_mode.sensor_mode = OT_WDR_MODE_NONE;
