...
/* 0x00F8 bit16: int_isp0_en
   0x00F8 bit0: int_pt0_en
   0x00F8 bit8: int_ch0_en */
...
td_void isp_drv_be_cfg_buf_addr_init(isp_be_buf_node *node, td_phys_addr_t phy_addr,
                                     td_u8 *vir_addr, td_u64 size, td_u8 i);
...
td_void isp_drv_set_hnr_bnr_cfg(isp_be_wo_reg_cfg *post_be, isp_drv_ctx *drv_ctx, td_bool bnr_bypass, td_bool ref_none);
